...
| `barclaycard-sample.csv` | `barclaycard_csv` | Barclaycard credit card: **tab-separated, no header**; `DD-Mon-YY`; debit/credit split (purchases positive, payment negative); `Crv*` rows are Curve-funded |
